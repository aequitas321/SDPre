public class HeronsFormulaStudyDrill {
    public static void main(String[] args) {
        ...
        System.out.println(tws + "9, 9, 9 has ares " + triangleArea(9, 9, 9));
    }
...
//The version without a funtcion is longer
//With out a function you would have to change the formula on every line that you are calculating
//Without a function adding another calculation would require writing the formula and more varables again